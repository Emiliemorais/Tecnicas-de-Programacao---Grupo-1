...
public class GerarRecibo extends JFrame
{
	...
	private static String RECIBO_PAGAMENTO = "RECIBO PAGAMENTO ALUGUEL BENS M√ìVEIS";
	...
	// MÈtodo utilizado para converter a data no formato da ABNT
	...
	// MÈtodo utilizado para converter a data no formato da ABNT sem a barra
	...
	// MÈtodo utilizado para converter a data no formato da ISO
	...
	public static void main(String[] args)
	{
		...
		(
			new Runnable()
			{
				...
				// MÈtodo que inicializa a janela de geraÁ„o de recibo
				public void run()
				{
					try 
					{
	...
	public GerarRecibo() throws ParseException
	{
		...
		btnGerarRecibo.addMouseListener(new MouseAdapter() 
		{
			...
			// MÈtodo utilizado para gerar um recibo no formato "docx"
			@Override
		...
		btnVoltar.addMouseListener(new MouseAdapter()
		{
			...
			// MÈtodo que volta para a janela administrativa
			@Override
	...
	// MÈtodo que mostra uma mensagem de erro, utilizado no tratamento das exceÁıes da classe
	private void mostrarMensagemDeErro(String informacao)
	{
		JOptionPane.showMessageDialog(null, informacao, "Aten√ß√£o",
