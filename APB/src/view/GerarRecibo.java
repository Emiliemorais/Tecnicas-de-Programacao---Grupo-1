...
public class GerarRecibo extends JFrame
{
	...
	// M�todo utilizado para converter a data no formato da ABNT
	...
	// M�todo utilizado para converter a data no formato da ABNT sem a barra
	...
	// M�todo utilizado para converter a data no formato da ISO
	...
	public static void main(String[] args)
	{
		...
		(
			new Runnable()
			{
				...
				// M�todo que inicializa a janela de gera��o de recibo
				public void run()
				{
					try 
					{
	...
	public GerarRecibo() throws ParseException
	{
		...
		btnGerarRecibo.addMouseListener(new MouseAdapter() 
		{
			...
			// M�todo utilizado para gerar um recibo no formato "docx"
			@Override
		...
		btnVoltar.addMouseListener(new MouseAdapter()
		{
			...
			// M�todo que volta para a janela administrativa
			@Override
	...
	// M�todo que mostra uma mensagem de erro, utilizado no tratamento das exce��es da classe
