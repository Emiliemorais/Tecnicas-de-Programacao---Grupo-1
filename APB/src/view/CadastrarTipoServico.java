...
public class CadastrarTipoServico extends JFrame 
{
	...
	// Construtor dos componentes da janela de Cadastro de tipo de serviÁo
	public CadastrarTipoServico() 
	{
		...
		btnAlterar.addMouseListener(new MouseAdapter() 
		{
			...
			// MÈtodo da VIEW que chama a janela de changeTypeService para realizar uma alteraÁ„o
			@Override
			public void mouseClicked(MouseEvent e) 
			{
				...
				{
					mostrarMensagemDeErro("Selecione um Tipo de Servi√ßo");
				}
			}
		});
