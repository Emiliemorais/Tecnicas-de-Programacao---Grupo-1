...
public class RelatorioTeste {
	...
	@Before
	/*
	 *  Incio do metodo setUp()
	 *  Ela tem a funcao de setar os valores na classe
	...
	/*
	 *  Inicio da classe  dataInicialNaoPodeSerSettadaNula()
	 *  Verifica se a data tratada e nula no metodo
	 *  Caso seja nula, uma excecao e detectada e tratada
	 */
	...
	/*
	 *  Inicio da classe  dataInicialNaoPodeSerSettadaEmBranco()
	 *  Verifica se a data tratada esta em braco dentro do metodo
	 *  Caso esteja em braco, uma excecao e detectada e tratada
	 */
	...
	@Test (expected = NullPointerException.class)
	/*
	 *  Inicio da classe  dataFinalNaoPodeSerSettadaNula()
	 *  Verifica se a data final tratada e nula no metodo
	 *  Caso seja nula, uma excecao e detectada e tratada
	 */
	...
	@Test (expected = AssertionError.class)
	/*
	 *  Inicio da classe  dataFinalNaoPodeSerSettaEmBranco()
	 *  Verifica se a data tratada esta em braco dentro do metodo
	 *  Caso esteja em braco, uma excecao e detectada e tratada
	 */
	...
	/*
	 *  Inicio da classe
	 *  Verifica se a variavel de entrada e nula no metodo
	 *  Caso seja nula, uma excecao e detectada e tratada
	 */
	@Test (expected = NullPointerException.class)
	...
	/*
	 *  Inicio da classe 
	 *  Verifica se a variavel tratada esta em braco dentro do metodo
	 *  Caso esteja em braco, uma excecao e detectada e tratada
	 */
	@Test (expected = AssertionError.class)
